...
Current focus: **M4c reporting** — REPORT/REPORTS + retention holds (invariants 11, 12). M4a (capabilities), M4b (namespaces + layout), and the recovery ladder (§2.4, invariant 9) are complete.
