...
Current focus: **M4c** — NS TRANSFER + the namespace recovery ladder (§2.4, invariant 9 — the subtlest code in the protocol, deserves a fresh session), then REPORT/REPORTS + retention holds. M4a (capabilities) and M4b namespaces + channel layout are complete.
