...
import { channels, nsOf, chanShort, layoutCache, type Channel } from "$lib/models/channel.svelte";
import { displayName, peerOf } from "$lib/profile.svelte";
import { groupLabel } from "$lib/models/social.svelte";
