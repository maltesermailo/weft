  ...
  {:else}
    ...
    {#if app.serverMenu}
      ...
      <div class="server-menu">
        ...
        {#if app.activeServer && app.serverCap("ns-admin")}
        ...
        {/if}
        {#if app.activeServer && app.canOpenServerSettings()}
        ...
        {#if app.activeServer && !app.isNsOwner(app.account)}
          <div class="sm-sep"></div>
          <button class="sm-item danger" onclick={app.nsLeave}>
            Leave Server
