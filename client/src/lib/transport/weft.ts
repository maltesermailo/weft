...
export type WeftEvent =
  ...
  | { kind: "ns-descriptor"; id: string; name: string; title: string | null; description: string | null; owner: string | null; visibility: string; federation: boolean; recovery_eta: number | null; recovery_rung: number | null; origin: string | null; provider_online: boolean | null }
  | {
      kind: "ns-meta";
