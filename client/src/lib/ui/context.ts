...
import type { ManifestInfo } from "$lib/federation/federation.svelte";
import type { Role } from "$lib/roles/role.svelte";
import type { Badge } from "$lib/session/session.svelte";
import type { InviteInfo } from "$lib/invites/invites.svelte";

export type RetentionMeta = { cls: string; label: string; icon: string };
export type { InviteInfo } from "$lib/invites/invites.svelte";
export type { Badge } from "$lib/session/session.svelte";
...
export type { Account } from "$lib/profile/account.svelte";
export type { Channel } from "$lib/channels/channel.svelte";
export type { Server } from "$lib/namespaces/server.svelte";
export type { Membership } from "$lib/membership/membership.svelte";
export type { Role } from "$lib/roles/role.svelte";
